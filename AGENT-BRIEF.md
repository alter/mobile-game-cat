...
| Лицензия Unity | активна; **пакетный режим работает** — проверено созданием проекта с `-batchmode -nographics -quit`, код возврата 0 |
...
Раз пакетный режим работает — сборку и прогон тестов запускай сам, не проси
человека нажимать в редакторе.
